...
public class EvolutionaryAlgorithm {
    ...
    int numIndividuTerseleksi = 80;// numIndividuTerseleksi harus lebih kecil dari numIndividu
    ...
    private void prosesEA() {
        if (status) {
            ...
            if(individuElitisme!=null){
                ...
                double a = individuElitisme.duration;
                double b = individuElitisme.cost;
                System.out.println("DURASI PROJECT: "+df.format(a)+" hari");
                System.out.println("BIAYA PROJECT : "+df.format(b));
                System.out.println("BEST FITNESS  : "+individuElitisme.fitness);
                individuElitisme.cetakKromosom();
                individuElitisme.cetakGanttDiagram();
            }
